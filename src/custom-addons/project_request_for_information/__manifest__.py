...
# Part of Probuse Consulting Service Pvt Ltd. See LICENSE file for full copyright and licensing details.
{
    ...
    'live_test_url': 'https://youtu.be/4iEiK-D1tEg',
    'version': '1.1.4',
    'category' : 'Project',
    'data':[
...
odoo Contracting
* INHERIT Portal My project requests: project requests (qweb)
* INHERIT Project Task form (form)
* INHERIT Project form (form)
* INHERIT job.costing.rfi.request.form (form)
* INHERIT res.partner.form.inherit (form)
* INHERIT survey.survey.rfi.request.form (form)
* INHERIT website_request_information_attachment (qweb)
