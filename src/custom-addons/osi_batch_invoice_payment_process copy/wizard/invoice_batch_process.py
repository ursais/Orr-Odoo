...
class InvoiceCustomerPaymentLine(models.TransientModel):
    ...
    def onchange_receiving_amt(self):
        ...
        discount_information = (
            rec.invoice_id.payment_term_id._check_payment_term_discount(
...
class InvoicePaymentLine(models.TransientModel):
    ...
    def onchange_paying_amt(self):
        ...
        if discount_information[2]:
            ...
            payment_amount = rec.invoice_id.residual
...
class AccountRegisterPayments(models.TransientModel):
            ...
            val.update(
                {
                    ...
                    "amt": abs(invoice_id.residual - discount_amt),
    ...
    def default_get(self, fields):
        ...
        if any(inv.payment_mode_id != invoices[0].payment_mode_id for inv in invoices):
            ...
            invoices with same payment mode"
                )
            )
        ...
        if "batch" in context and context.get("batch"):
            ...
            if MAP_INVOICE_TYPE_PARTNER_TYPE[invoices[0].type] == "customer":
                for inv in invoices:
                    ...
                    discount_information = (
                        inv.payment_term_id._check_payment_term_discount(
                            inv, payment_date
                        )
                    )
                    discount_amt = discount_information[0]
