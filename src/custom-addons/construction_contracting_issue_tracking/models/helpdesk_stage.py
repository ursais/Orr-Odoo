...
class ConstructionStageConfig(models.Model):
    _name = "construction.stage.config"
    ...
    def default_get(self, fields):
        ...
        return super(ConstructionStageConfig, self.with_context(ctx)).default_get(fields)
