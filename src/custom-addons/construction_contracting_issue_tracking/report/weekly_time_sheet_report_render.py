...
class WeeklyTimeSheetReport(models.AbstractModel):
    _name = 'report.construction_contracting_issue_tracking.report_weekly'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('construction_contracting_issue_tracking.report_weekly', docargs)
