...
class PurchaseOrder(models.Model):
    ...
    last_date_received = fields.Datetime(string="Last Date Received", compute="_compute_last_date_received", store=True)
    last_bill_date = fields.Datetime(string="Last Bill Date", compute="_compute_last_bill_date", store=True)
    uigr_value = fields.Monetary(string="UIGR Value", compute='_compute_uigr_value', store=True)
...
class PurchaseOrderLine(models.Model):
    ...
    uigr_value = fields.Monetary(string="UIGR Value", compute='_compute_uigr_value', store=True)
    bo_value = fields.Monetary(string="Backorder Value", compute='_compute_bo_value', store=True)
    product_type = fields.Selection( related='product_id.product_tmpl_id.type',string='Product Type')
