...
{
    'name': "Machine Repair Management (All Types of Machines)",
    'currency': 'EUR',
    'price': 109.0,
...
#                 'hr_timesheet_sheet',
    ...
    'data':[
        ...
        'datas/machine_repair_support_sequence.xml',
        'datas/mail_template_ticket.xml',
        'views/machine_repair_support_view.xml',
        'views/machine_repair_support_template.xml',
        ...
        'views/task.xml',
        'views/thankyou.xml',
        'report/machine_repair_analysis.xml',
        ...
        'report/report_machine_repair_lable.xml',
        'views/menus.xml',
